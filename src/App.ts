      ...
      <main class="app-shell">
        ...
        <footer class="site-footer">
          ...
          <nav class="contact-links" aria-label="Contact Mark Struck">
            <a href="https://x.com/mark_struck" target="_blank" rel="noreferrer" title="Mark Struck on X">
              <svg aria-hidden="true" viewBox="0 0 24 24">
                <path d="M14.234 10.162 22.977 0h-2.072l-7.591 8.824L7.251 0H.258l9.168 13.343L.258 24H2.33l8.016-9.318L16.749 24h6.993zm-2.837 3.299-.929-1.329L3.076 1.56h3.182l5.965 8.532.929 1.329 7.754 11.09h-3.182z"/>
              </svg>
              <span class="visually-hidden">Mark Struck on X</span>
            </a>
            <a href="mailto:markstruck@comcast.net" target="_blank" rel="noreferrer" title="Email Mark Struck">
              <svg aria-hidden="true" viewBox="0 0 24 24" fill="none">
                <path d="M21.75 6.75v10.5a2.25 2.25 0 0 1-2.25 2.25h-15a2.25 2.25 0 0 1-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0 0 19.5 4.5h-15a2.25 2.25 0 0 0-2.25 2.25m19.5 0v.243a2.25 2.25 0 0 1-1.07 1.916l-7.5 4.615a2.25 2.25 0 0 1-2.36 0L3.32 8.91a2.25 2.25 0 0 1-1.07-1.916V6.75"/>
              </svg>
              <span class="visually-hidden">Email Mark Struck</span>
            </a>
            <a href="https://github.com/struckm" target="_blank" rel="noreferrer" title="Mark Struck on GitHub">
              <svg aria-hidden="true" viewBox="0 0 24 24">
